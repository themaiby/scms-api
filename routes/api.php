...
Route::prefix('v1')->middleware('api')->group(static function () {
     ...
     * Vendors
     */
    Route::prefix('vendors')->where(['vendor' => '[0-9]+'])->group(static function () {
     ...
     * Components
     */
    Route::prefix('components')->where([
        'component' => '[0-9]+', 'componentCategory' => '[0-9]+'
     ...
     * Partners
     */
    Route::prefix('partners')->where(['partner' => '[0-9]+'])->group(static function () {
    ...
    Route::prefix('orders')
        ->where(
             ...
             * Order statuses
             */
            Route::prefix('statuses')->group(static function () {
            ...
            Route::prefix('{order}/components')->group(static function () {
